...
func SpecifierSpecifyRequest(_ *connectorv1.Specifier_Specify_Request) cplugin.SpecifierSpecifyRequest {
	return cplugin.SpecifierSpecifyRequest{}
}

// -- Response Conversions ----------------------------------------------------

func SpecifierSpecifyResponse(in *connectorv1.Specifier_Specify_Response) (cplugin.SpecifierSpecifyResponse, error) {
