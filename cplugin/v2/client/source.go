...
func NewSourcePluginClient(grpcClient connectorv2.SourcePluginClient) cplugin.SourcePlugin {
	return &SourcePluginClient{grpcClient: grpcClient}
}
...
func (s *SourceRunStream) Recv() (cplugin.SourceRunResponse, error) {
	...
	if err != nil {
		if err == io.EOF {
			return cplugin.SourceRunResponse{}, cplugin.ErrStreamNotOpen
		}
