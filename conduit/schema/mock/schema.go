...
// Source: github.com/conduitio/conduit-connector-protocol/conduit/schema (interfaces: Service)
//
// Generated by this command:
//
//	mockgen -destination=mock/schema.go -package=mock -mock_names=Service=Service . Service
//
...
import (
	...
	schema "github.com/conduitio/conduit-connector-protocol/conduit/schema"
...
func (m *Service) Create(arg0 context.Context, arg1 schema.CreateRequest) (schema.CreateResponse, error) {
	m.ctrl.T.Helper()
...
func (mr *ServiceMockRecorder) Create(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*Service)(nil).Create), arg0, arg1)
}

// Get mocks base method.
func (m *Service) Get(arg0 context.Context, arg1 schema.GetRequest) (schema.GetResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", arg0, arg1)
	ret0, _ := ret[0].(schema.GetResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
