...
func SpecifierSpecifyRequest(_ pconnector.SpecifierSpecifyRequest) *connectorv1.Specifier_Specify_Request {
	return &connectorv1.Specifier_Specify_Request{}
}

// -- Response Conversions ----------------------------------------------------

func SpecifierSpecifyResponse(in pconnector.SpecifierSpecifyResponse) *connectorv1.Specifier_Specify_Response {
