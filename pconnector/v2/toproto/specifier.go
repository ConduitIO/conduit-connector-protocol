...
func SpecifierSpecifyRequest(_ pconnector.SpecifierSpecifyRequest) *connectorv2.Specifier_Specify_Request {
	return &connectorv2.Specifier_Specify_Request{}
}

// -- Response Conversions ----------------------------------------------------

func SpecifierSpecifyResponse(in pconnector.SpecifierSpecifyResponse) *connectorv2.Specifier_Specify_Response {
	return &connectorv2.Specifier_Specify_Response{
		Specification: Specification(in.Specification),
	}
}

func Specification(in pconnector.Specification) *connectorv2.Specification {
