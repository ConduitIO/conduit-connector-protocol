...
// Source: github.com/conduitio/conduit-connector-protocol/cpluginv2 (interfaces: SpecifierPlugin)
//
...
func (m *SpecifierPlugin) Specify(arg0 context.Context, arg1 cpluginv2.SpecifierSpecifyRequest) (cpluginv2.SpecifierSpecifyResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Specify", arg0, arg1)
	ret0, _ := ret[0].(cpluginv2.SpecifierSpecifyResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
